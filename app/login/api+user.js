import { requestHTML, requestJSON } from '../base/api+base'
...
// 获取权限
const api_auths_moduleRights =
  '/admin/auths/{appCode}/moduleRights/{moduleCode}' // GET deptId=
...
export async function getProjects(page, size) {
  return requestJSON(
    `${api_pmbasic_projects_available}?sort=createTime,desc&page=${page}&size=${size}`,
    {
      method: 'GET',
    }
  )
